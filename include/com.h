...
/* Letra C: Estatisticas de I/O */
#undef VFS_GET_IO_STATS
#define VFS_GET_IO_STATS   (0x100 + 63)
...
/* --- ADICIONE ISTO AQUI (Letra B) --- */
#define VM_GET_MEM_STATS    (VM_RQ_BASE+55)
...
#define VM_BASIC_CALLS \
    ...
    VM_GETRUSAGE, VM_GET_MEM_STATS /* VM_GETRUSAGE is to be removed from this list ASAP */
