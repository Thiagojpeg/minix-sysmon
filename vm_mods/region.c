 ...
 */
    ...
    /* === LETRA B: CONTAGEM DE LIBERACAO === */
    /* Se a desalocação ocorreu, somamos o numero de paginas liberadas ao contador */
    /* len é o tamanho em bytes, dividimos por VM_PAGE_SIZE para ter o numero de paginas */
        if (vmp) {
        vmp->vmp_pages_freed += (len / VM_PAGE_SIZE);
    }
