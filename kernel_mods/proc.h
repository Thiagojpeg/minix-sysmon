...
/* ========================================================== *
 * Modificacao SysMon: Metricas de Desempenho                 *
 * ========================================================== */
u64_t p_total_runtime;        /* Tempo total na CPU em ticks */
u64_t p_total_runtime_start;  /* Marca temporal de inicio */
long p_context_switches;      /* Contador de trocas de contexto*/
