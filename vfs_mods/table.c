...
#include "vnode.h"
#include "vmnt.h"
/* Definicao manual para destravar a compilacao da Letra C */
#ifndef VFS_GET_IO_STATS
#define VFS_GET_IO_STATS (0x100 + 55)
#endif
...
int (* const call_vec[NR_VFS_CALLS])(void) = {
	...
	CALL(VFS_GETPEERNAME)	= do_getpeername,	/* getpeername(2) */
     /* CALL(VFS_SHUTDOWN)      = do_shutdown, */    /* shutdown(2) */
        CALL(VFS_GET_IO_STATS)  = do_get_io_stats,  /* Letra C - Vaga 55 */
};
